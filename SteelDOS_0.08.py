...
def helpcom():
    ...
    if knowledgebas == 1:
        ...
        print ("fileman: File Manager program")
        print ("dice: Dice-rolling program")
        print ("listmakr: List Making program")
        print ("clock: Program that displays time")
...
def speakcom():
    programinpu = input("\n-- Speak.Com 0.08 SteelDOS --\n\nTell me what to say: ")
    print (programinpu)



def calcucom():
    print ("\n-- SteelDOS Calculator 0.08 --")
    operator = int(input("\n1 = Add numbers\n2 = Subtract numbers\n3 = Multiply numbers\n4 = Divide numbers\nSelect an operation to do: "))
    if operator == 1:
        calcvala = float(input("Enter the first number: ")) # float() used instead of int() to patch ^_^
        calcvalb = float(input("Enter the second number: "))
        calcvalc = (calcvala + calcvalb)
        print (calcvala, "+", calcvalb, "=", calcvalc)
        
    elif operator == 2:
        calcvala = float(input("Enter the first number: "))
        calcvalb = float(input("Enter the second number: "))
        calcvalc = (calcvala - calcvalb)
        print (calcvala, "-", calcvalb, "=", calcvalc)
...
while dosline == 1:
    ...
    if command == "help" or command == "help.com":
        ...
        print ("\nSteelDOS version 0.08 [Version 0.08.66 Codename \"Mystic\"]")
